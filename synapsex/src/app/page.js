          ...
          <div className="contact-content">
            ...
            <div className="social-media">
              ...
              <div className="social-icons">
                <a href="https://instagram.com/synapsex_gt" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
                ...
                <a href="https://linkedin.com/company/synapsex-gt" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://synapsex-gt.slack.com" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Slack">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
